...
<body>
    ...
    <div class="card-body">
        <form method="post" action="<?= site_url('halamanutama/insert') ?>">
            <div class="form-group">
                <label for="nama">Nama</label>
                <input type="text" class="form-control" id="inputNama" name="inputNama" placeholder="Silahkan Masukan Nama">
            </div>
            <div class="form-group">
                <label for="NIM">NIM</label>
                <input type="text" class="form-control" id="inputNIM" name="inputNIM" placeholder="Silahkan Masukkan NIM">
            </div>
